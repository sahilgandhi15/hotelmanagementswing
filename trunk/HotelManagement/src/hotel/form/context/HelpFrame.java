...
public class HelpFrame extends BasePanel {
	...
	public HelpFrame(MainFrame parent) {
		...
		Image image = ResourceReader.getImageFromJar("resources/welcome.JPG", this.getClass().getClassLoader());
		JImagePane panel = new JImagePane(image/*new ImageIcon("./resources/welcome.JPG").getImage()*/, JImagePane.SCALED);
		p.add(panel);
		image = ResourceReader.getImageFromJar("resources/room_01_big.jpg", this.getClass().getClassLoader());
		panel = new JImagePane(image/*new ImageIcon("./resources/room_01_big.jpg").getImage()*/, JImagePane.SCALED);
		p.add(panel);
		image = ResourceReader.getImageFromJar("resources/room_02_big.jpg", this.getClass().getClassLoader());
		panel = new JImagePane(image/*new ImageIcon("./resources/room_02_big.jpg").getImage()*/, JImagePane.SCALED);
		p.add(panel);
		image = ResourceReader.getImageFromJar("resources/room_04_big.jpg", this.getClass().getClassLoader());
		panel = new JImagePane(image/*new ImageIcon("./resources/room_04_big.jpg").getImage()*/, JImagePane.SCALED);
		p.add(panel);
		image = ResourceReader.getImageFromJar("resources/room_05_big.jpg", this.getClass().getClassLoader());
