...
public class DingRoomFrame2 extends JDialog implements ActionListener, ItemListener {
	/**
	 * 
	 */
	...
	public DingRoomFrame2(DingRoom parent) {
		this.parent = parent;
		this.setLayout(null);
		this.setModal(true);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (str.equals("true")) {
			...
			try {
				...
				dingRoom.setCreate(DateUtil.getDate(dingRoomDate.getText().trim()));
				dingRoom.setPledge(Float.parseFloat(jTextField4.getText().trim()));
				Map condition = new HashMap();
